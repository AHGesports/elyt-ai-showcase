...
- "Run, schedule, and monitor browser tasks at scale"
- "Works with your existing browser profile providers"
- "Private commercial platform, public showcase"

Avoid:

- Implementation details that help bypass third-party defenses.
- Abuse-focused personas such as scalping, account farming, spam, or ban evasion.
- Claims that cannot be verified publicly.
- Internal names as primary branding.
